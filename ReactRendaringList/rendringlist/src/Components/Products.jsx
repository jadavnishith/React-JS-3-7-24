...
function Products() {
  const productData = ProductData.map((product) => (
    <li key={product.id}>
      <div
        className="card"
        style={{
      ...
      >
        ...
        <div className="card-body d-flex flex-column">
          ...
          <a href="#" className="btn btn-success mt-auto fw-bolde" style={{ width: '90px' }}>
            ₹ {product.price}
          </a>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <h1 className="text-center mt-5 bg-success-subtle rounded-5">All Products</h1>
